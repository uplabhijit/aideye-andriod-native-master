...
//        getSupportActionBar().hide();
    ...
    public void initLanguageSpinner()
    {
        ...
        final ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.listValues));
        ...
        if (adapter != null) {
            ...
            spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    if (adapter.getItem(position).toString().equalsIgnoreCase("Select language"))
                        return;

                    MeMePref.addIntPreference(SettingActivity.this, position, MeMeConstant.PREF_VOICE_SPINNER_POSITION);

                    System.out.println("selected language---------" + adapter.getItem(position).toString());
                    ...
                    setTtsLang(adapter.getItem(position).toString());
